...
const procTemplate = `//go:build windows && amd64
...
//
// This laziness is not something realLazyProc{{.Suffix}}.Call implements
// itself: it calls syscall.SyscallN(r.LazyProc.Addr(), ...) directly
// (bypassing windows.LazyProc.Call -- see realLazyProc{{.Suffix}}'s own doc
